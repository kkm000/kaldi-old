...
template<class KeyType, class EntryType, class RegisterType>
__declspec(selectany) FstOnceType GenericRegister<KeyType, EntryType,
                               RegisterType>::register_init_ = FST_ONCE_INIT;

template<class KeyType, class EntryType, class RegisterType>
__declspec(selectany) Mutex *GenericRegister<KeyType, EntryType, RegisterType>::register_lock_ = nullptr;

template<class KeyType, class EntryType, class RegisterType>
__declspec(selectany) RegisterType *GenericRegister<KeyType, EntryType, RegisterType>::register_ = nullptr;
#endif
