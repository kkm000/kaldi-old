...
class FstClass : public FstClassBase {
 public:
  ...
  static OPENFSTDLL FstClass *Read(const string &fname); //ChangedPD
...
class MutableFstClass : public FstClass {
 public:
  ...
  static OPENFSTDLL  MutableFstClass *Read(const string &fname, bool convert = false); //ChangedPD
...
class VectorFstClass : public MutableFstClass {
 public:
  explicit OPENFSTDLL VectorFstClass(const FstClass &other); //ChangedPD
  explicit OPENFSTDLL VectorFstClass(const string &arc_type); //ChangedPD
