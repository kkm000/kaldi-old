...
void OPENFSTDLL PdtCompose(const FstClass & ifst1, //ChangedPD
...
void OPENFSTDLL PdtExpand(const FstClass &ifst, //ChangedPD
               const vector<pair<int64, int64> > &parens,
...
void OPENFSTDLL PdtReplace(const vector<pair<int64, const FstClass*> > &fst_tuples, //ChangedPD
                MutableFstClass *ofst,
...
void OPENFSTDLL PdtReverse(const FstClass &ifst, //ChangedPD
                const vector<pair<int64, int64> > &parens,
                MutableFstClass *ofst);
...
void OPENFSTDLL PdtShortestPath(const FstClass &ifst, //ChangedPD
                     const vector<pair<int64, int64> > &parens,
                     MutableFstClass *ofst,
...
void OPENFSTDLL PrintPdtInfo(const FstClass &ifst, //ChangedPD
                  const vector<pair<int64, int64> > &parens);
