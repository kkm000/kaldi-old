...
void OPENFSTDLL FarCompileStrings( //ChangedPD
    const vector<string> &in_fnames,
    const string &out_fname,
...
void OPENFSTDLL FarCreate(const vector<string> &in_fnames, //ChangedPD
               const string &out_fname,
               const string &arc_type,
               const int32 generate_keys,
               const bool file_list_input,
...
void OPENFSTDLL FarExtract(const vector<string> &ifilenames, //ChangedPD
                const string &arc_type,
...
void OPENFSTDLL FarInfo(const vector<string> &filenames, //ChangedPD
             const string &arc_type,
...
void OPENFSTDLL FarPrintStrings(const vector<string> &ifilenames, //ChangedPD
                     const string &arc_type,
                     const FarEntryType entry_type,
                     const FarTokenType token_type,
                     const string &begin_key,
